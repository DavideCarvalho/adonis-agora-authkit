...
Declare it yourself, parameterised over your model — this is what most apps want, and what
[Getting started](/docs/getting-started) shows:

```ts title="types/authkit.ts"
...
<Callout type="warn">
  Never do both. `HttpContext.auth` declared twice with different types does not merge —
